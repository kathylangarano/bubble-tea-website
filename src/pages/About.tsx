  ...
  return (
    <div className="about-container">
      <img
            ...
            src="../../public/assets/images/no products.jpeg"
            alt="Primer slide"
          />
      ...
      <div className="content-section">
        ...
        <div className="image-section">
              <img src="../../public/assets/images/about4.jpeg" alt="Imagen representativa" /> 
        </div>
      </div>
      
      <img
            className="d-block w-100"
            src="../../public/assets/images/about1.jpeg"
            alt="Primer slide"
          />
      ...
      <div className="image-section">
          <img src="../../public/assets/images/about3.jpeg" alt="Segunda imagen representativa" />
      </div>
